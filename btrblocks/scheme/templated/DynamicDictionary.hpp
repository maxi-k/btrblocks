...
#pragma GCC diagnostic ignored "-Wuninitialized"
  if (tuple_count >= 16) {
    while (i < tuple_count - 15) {
      ...
      // gather values
      __m256i values_0 = _mm256_i32gather_epi64(dict, codes_0, 8);
      __m256i values_1 = _mm256_i32gather_epi64(dict, codes_1, 8);
      __m256i values_2 = _mm256_i32gather_epi64(dict, codes_2, 8);
      __m256i values_3 = _mm256_i32gather_epi64(dict, codes_3, 8);

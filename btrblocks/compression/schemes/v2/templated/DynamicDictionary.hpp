 ...
 public:
  ...
  static inline u32 compressColumn(const NumberType* src,
    ...
    IntegerSchemePicker::compress(
        codes.data(), nullptr, write_ptr, codes.size(), allowed_cascading_level - 1, used_space,
        col_struct.codes_scheme_code, CB(IntegerSchemeType::FBP), "codes");
    // -------------------------------------------------------------------------------------

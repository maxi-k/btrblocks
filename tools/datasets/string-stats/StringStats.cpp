...
// -------------------------------------------------------------------------------------
// -------------------------------------------------------------------------------------
map<string, string> analyzeBlock(Vector<str> &column, Vector<BITMAP> &bitmap, u32 start_index, u32 tuple_count, bool print_block = false)
{
   map<string, string> stats;
   stats["random_element"] = column[start_index];
   ...
   stats["min"] = to_string(max_length);
